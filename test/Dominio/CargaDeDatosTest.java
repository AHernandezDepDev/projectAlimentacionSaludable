...
public class CargaDeDatosTest {
    ...
    public Usuario cargarUsuario(Usuario expResultUsuario, PlanAlimentacion expResultPlanAlimentacion,
        ...
        Alimento alimentoJUnit = new Alimento();
        alimentoJUnit = cargarAlimento(alimentoJUnit);
        
        Ingesta ingestaJUnit = new Ingesta();
        ingestaJUnit = cargarIngesta(ingestaJUnit, alimentoJUnit);
        
        Profesional profesionalJUnit = new Profesional();
        profesionalJUnit = cargarPorfesional(profesionalJUnit);
        
        consultaJUnit = cargarConsulta(consultaJUnit, alimentoJUnit, 
                profesionalJUnit, expResultUsuario);
        
        expResultPlanAlimentacion = cargarPlanDeAlimentacion(expResultPlanAlimentacion, 
                consultaJUnit);
        ...
        listaIngesta.add(ingestaJUnit);
        listaConsulta.add(consultaJUnit);
        listaPlanAlimentacion.add(expResultPlanAlimentacion);
    ...
    public Consulta cargarConsulta(Consulta expConsulta, Alimento expAlimento,
            Profesional expProfesional, Usuario expUsuario) {
        
        expConsulta.setAlimentoConsultado(expAlimento);
        expConsulta.setDescripcionConsulta("Me gustaria saber nutrientes de la Carne");
        expConsulta.setIdConsulta(1);
        expConsulta.setProfesionalRespondeConsulta(expProfesional);
        expConsulta.setRespuestaConsulta("Tiene como nutrientes: Hierro, Proteinas");
        expConsulta.setSolcitante(expUsuario);
        expConsulta.setTitularConsulta("Informacion alimento Manzana");
